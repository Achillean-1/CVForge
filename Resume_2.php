        ...
        <section id = "preview-sc" class = "print_area">
            <div class = "container">
                <div class = "preview-cnt">
                    <div class = "preview-cnt-l bg-white text-dark">
                    ...
                    <div class = "preview-cnt-r bg-white">
                        ...
                        <div class = "preview-blk">
                            ...
                            <div class = "preview-blk-list">
                                <div class = "preview-item">
                                    Alamat: <span class = "preview-item-val" id = "address_dsp"></span>
                                </div>
                                <div class = "preview-item">
                                    Email: <span class = "preview-item-val" id = "email_dsp"></span>
                                </div>
                                <div class = "preview-item">
                                    No. Telepon: <span class = "preview-item-val" id = "phoneno_dsp"></span>
                                </div>
                            </div>
                        </div>
                    </div>
